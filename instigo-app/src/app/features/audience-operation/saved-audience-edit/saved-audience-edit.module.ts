...
import { SavedAudienceModalTriggerComponent } from './saved-audience-modal-trigger.component';

@NgModule({
  declarations: [SavedAudienceEditComponent, SavedAudienceModalTriggerComponent],
  imports: [
    CommonModule,
  ...
  exports: [SavedAudienceEditComponent],
})
export class SavedAudienceEditModule {}
